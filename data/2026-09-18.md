...
### [18] [FINSKILLOPS: A Self-Evolving Multi-Agent System for SEC Filing QA](https://arxiv.org/abs/2609.19680)
...
### [21] [Q&A on Any Spreadsheet Requires Interpreting Its Grid Structure](https://arxiv.org/abs/2609.20732)
*Zofia Smoleń*
...
### [23] [An Empirical Study of Harness Design for Coding Agents](https://arxiv.org/abs/2609.20804)
...
### [90] [Splyce: SIMD Vectorization of Sparse Coiteration](https://arxiv.org/abs/2609.19410)
...
### [91] [LLVM Translation Validation Automated with Large Language Models and Lean](https://arxiv.org/abs/2609.19583)
...
### [92] [Theories of Mind as Domain-Specific Languages of Thought](https://arxiv.org/abs/2609.19598)
...
### [93] [The Output-Space Hypothesis: Enumerative Equivalence Checking for Tensor Programs](https://arxiv.org/abs/2609.19611)
...
### [94] [Metamorphic Testing for Floating-Point Performance Issues in SMT Solvers](https://arxiv.org/abs/2609.19735)
...
### [95] [How Often Does Your Program Fail?](https://arxiv.org/abs/2609.20037)
...
### [96] [Code-as-Auditor: Executable Compliance Reasoning via Regulation-to-Code](https://arxiv.org/abs/2609.19199)
...
### [97] [DeltaSelect: Affordable A/B Testing for Coding Agents](https://arxiv.org/abs/2609.19607)
*Nicholas J. Conn*
...
### [98] [BA-TRACE: Boundary-Aware Trace Reconstruction for Scenario-Based Evaluation of Mixed AUTOSAR Adaptive and ROS 2 Vehicular Embedded Systems](https://arxiv.org/abs/2609.19699)
...
### [99] [A Closed-Loop Control Architecture for Reliable Constraint Satisfaction in LLM Text Generation](https://arxiv.org/abs/2609.19710)
...
### [100] [EviRCA: Decoupling Evidence Extraction from Reasoning for Microservice Root-Cause Analysis](https://arxiv.org/abs/2609.19825)
...
### [101] [HapCiD: Detecting API-related Compatibility Issues in OpenHarmony Apps](https://arxiv.org/abs/2609.20099)
...
### [102] [AdaRepair-Mem: Adaptive Experience Orchestration for Repository-Level Program Repair](https://arxiv.org/abs/2609.20130)
...
### [103] [CodeTransBenchmark: Evaluating LLM-based Code Translation and Repair Across Programming Languages](https://arxiv.org/abs/2609.20257)
...
### [104] [Evaluating Package-Level Scoping Strategies for Repository-Level Code Completion in Pharo](https://arxiv.org/abs/2609.20279)
...
### [105] [Towards a Characterization of Microservice Architectures Generated by Large Language Models](https://arxiv.org/abs/2609.20308)
...
### [106] [Assessing the Construct Validity of Object-Oriented, Class-Level Code Quality Metrics](https://arxiv.org/abs/2609.20411)
...
### [107] [Spotlights: Discovering Improvement Opportunities in Software Repositories](https://arxiv.org/abs/2609.20446)
...
### [108] [Quantifying Overclaiming Propensity in Frontier LLM Agents](https://arxiv.org/abs/2609.20812)
...
### [109] [EvoSherlock: Towards Agentic Lifelong Evolution for Unseen Long-Tailed Security-Critical Events in Videos](https://arxiv.org/abs/2609.19201)
...
### [111] [Robust Conformal Intrusion Detection via Traffic-Aware Calibration and Attack-Orbit Invariance](https://arxiv.org/abs/2609.19241)
*Zhenpeng Li*
...
### [112] [AUDITPLAN: Commit, Then Answer for Auditable Safety Alignment](https://arxiv.org/abs/2609.19325)
...
### [113] [Scaling Zero Knowledge UNSAT Verification via Normalized Chaining](https://arxiv.org/abs/2609.19353)
...
### [114] [Beyond Private Training: The New Landscape of AI Privacy](https://arxiv.org/abs/2609.19456)
...
### [115] [Red-Teaming Auto Mode: Improving Blocking Classifiers Against Malign Coding Agents](https://arxiv.org/abs/2609.19587)
...
### [116] [SoK: Trading Agents or Market Crashers? Dissecting Robustness and Security Failures in Academic Financial LLM Trading Schemes](https://arxiv.org/abs/2609.19705)
...
### [117] [Reachability, Not Observation: Containing Systems Whose Wiring Changes](https://arxiv.org/abs/2609.19720)
*Yoshiaki Takashita*
...
### [118] [ALIBI: Adversarial Legitimacy Injection in Binary Input against LLM Malware Analyzers](https://arxiv.org/abs/2609.19722)
...
### [119] [Sybil-TraceGuard: Traceability-enhanced Sybil Guardian for Connected and Autonomous Vehicles Using Dynamic Semi-supervised GNN](https://arxiv.org/abs/2609.19791)
...
### [120] [Trust, but Validate the Instrument: Auditing AI-Generated RTL Verification Plans on Authored Security-Regression Proxies](https://arxiv.org/abs/2609.19844)
...
### [121] [ClashBench: Conflicts Leading Agents to Seize and Harm](https://arxiv.org/abs/2609.19892)
...
### [122] [Hopper: Bounded-Memory Collaborative Debiasing for Byzantine-Tolerant Peer Sampling](https://arxiv.org/abs/2609.19893)
...
### [123] [Delphi Scanner: efficient and interpretable static malware detection via API sequence modeling](https://arxiv.org/abs/2609.19900)
...
### [124] [Mind the Gap: How SBOM Specification Ambiguities Lead to Divergent Software Bills of Materials. An Empirical Tool Study](https://arxiv.org/abs/2609.19920)
...
### [125] [On the Leakage of Massey Secret Sharing Schemes under Linear Computations](https://arxiv.org/abs/2609.19929)
...
### [126] [JANUS: Denial-of-Service Attack Against Beam Hopping in LEO Satellite Networks](https://arxiv.org/abs/2609.19977)
...
### [127] [XIR: A Framework for Interoperability across Cross-Chain Protocols Based on a Verifiable Intermediate Representation](https://arxiv.org/abs/2609.20010)
...
### [128] [Competition, Collusion, and Corruption: The Spectrum of MEV Attacks on DAG-Based BFT Consensus Protocols](https://arxiv.org/abs/2609.20069)
...
### [129] [A Scalable Trust Discovery Architecture for the Internet of Agents](https://arxiv.org/abs/2609.20095)
...
### [130] [ResumeShield: Channel Separation and an Open Benchmark for Indirect Prompt Injection in AI Resume Screening](https://arxiv.org/abs/2609.20188)
*Jay Barach*
...
### [131] [Silence Is Endorsement: Verification-Status Laundering in LLM Agent Pipelines](https://arxiv.org/abs/2609.20211)
*Yibo Hu*
...
### [132] [DDQN-MLP: An Explainable and Adversarially Robust DRL-Guided Adaptive Learning Framework for Ransomware Detection](https://arxiv.org/abs/2609.20314)
...
### [133] [The More It Says, the More You Pay: A Black-Box Audit of Provider-Side Token Inflation in LLM Services](https://arxiv.org/abs/2609.20370)
...
### [134] [Fingerprinting Multimodal Large Language Models](https://arxiv.org/abs/2609.20457)
...
### [135] [Towards TEE-Certified DP: Verifiable Differentially Private Training on Legacy GPUs](https://arxiv.org/abs/2609.20532)
...
### [136] [Empirical Analysis of Randomness Quality in Differential Privacy Mechanisms](https://arxiv.org/abs/2609.20561)
...
### [137] [Weather Data Spoofing Attacks on Rain-Adaptive Millimeter-Wave Frequency Selection in V2X Communication Networks](https://arxiv.org/abs/2609.20601)
...
### [138] [Inference-Engine Fingerprinting Attacks are Practical: Exploring Model-Driven Environmental Discovery, Exploitation, and Escape](https://arxiv.org/abs/2609.20614)
