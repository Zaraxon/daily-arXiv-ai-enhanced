...
### [5] [LogicTrack: Auditing Reasoning Trajectories of Large Language Models with Formal Logic Solvers](https://arxiv.org/abs/2609.21492)
...
### [14] [AI-GRACE: A Use-Case Operationalization Framework for Agentic AI: From Organizational Objectives and Obligations to Deployment Capabilities and Architecture](https://arxiv.org/abs/2609.21192)
...
### [15] [GameASG-Bench: Benchmarking Autonomous Software Generation for Game Development](https://arxiv.org/abs/2609.21293)
...
### [50] [Authorization Revocation for Long-Running AI Agents: Root-Scoped Quiescence under Delegation and Asynchronous Execution](https://arxiv.org/abs/2609.21284)
...
### [51] [Helpful but Fallible: Developer Experiences of AI Tools Under a Coordinated Industrial Roll-out](https://arxiv.org/abs/2609.20977)
...
### [52] [Embedding Drift in Code Vulnerability Models Under Intended Behaviour-Preserving Transformations](https://arxiv.org/abs/2609.21203)
...
### [53] [License Compliance in Open Source Cybersecurity Projects](https://arxiv.org/abs/2609.21218)
...
### [54] [What Stops a Small Language Model From Driving a Database Agent](https://arxiv.org/abs/2609.21341)
...
### [55] [Cross-Platform vs Native Mobile Development: An Empirical Study of Software Quality Trade-offs](https://arxiv.org/abs/2609.21544)
*Alexandru Ilovan*
...
### [56] [GameLogicBench: Evaluating Coding Agents on Runtime Game Logic with Tick-Level State Assertions](https://arxiv.org/abs/2609.21562)
...
### [57] [Labelling Bug-Fixing Commits with Local Open-Weight Language Models](https://arxiv.org/abs/2609.21616)
...
### [58] [From Smarter to Hungrier: the Role of Energy Efficiency in Software-defined Vehicles](https://arxiv.org/abs/2609.21643)
*Ella Peltonen*
...
### [59] [Supporting Industrial Test-Failure Analysis with LLM-Based Systems: An Experience Report](https://arxiv.org/abs/2609.21843)
...
### [60] [How Researchers Use and Verify AI Coding Assistants: Tasks and Validation Practices in Scientific Programming](https://arxiv.org/abs/2609.22049)
...
### [61] [The Right Tool for the Job: On the Selection of Mitigations for GenAI Privacy Threats](https://arxiv.org/abs/2609.20884)
...
### [62] [TPM-Attest: Hardware-Rooted Integrity Attestation as a Kernel-Level Anti-Cheat Alternative for Linux](https://arxiv.org/abs/2609.20909)
...
### [63] [(Don't) Trust, but (Don't) Verify: Developers' Attention to Security in AI-Generated Code](https://arxiv.org/abs/2609.21020)
...
### [64] [Loopjacking: Hijacking Human-in-the-Loop Approval](https://arxiv.org/abs/2609.21081)
*Adithyan Arun Kumar*
...
### [65] [Origin Is All You Need: Provenance-Aware Transformers for Structural Trust-Boundary Separation](https://arxiv.org/abs/2609.21088)
...
### [66] [NetInspector: Measuring and Improving LLM Capabilities for Reliable Intent-Based Networking Policy Generation](https://arxiv.org/abs/2609.21103)
...
### [67] [Toss If Perishable: An Ethnographic Study on Building Scenario-Based Training for Non-Perishable Skills](https://arxiv.org/abs/2609.21147)
...
### [68] [X-SPUR: Explainable Surprisal-Based Protocol-Aware Unsupervised Reasoning for Automotive Ethernet Intrusion Detection](https://arxiv.org/abs/2609.21217)
...
### [69] [Combining Exploratory Analysis and Automated Analysis for Anomaly Detection in Real-Time Data Streams](https://arxiv.org/abs/2609.21222)
...
### [70] [Transcript-Bound Combiners for Downgrade-Resilient Hybrid Post-Quantum Key Establishment: Definition, Proof, and Embedded-Device Cost](https://arxiv.org/abs/2609.21273)
...
### [71] [Identifying Security Platform Product Abuse with Machine Learning](https://arxiv.org/abs/2609.21303)
...
### [72] [Conformal Privacy Auditing: Calibrated Re-identification Attacks with Statistical Guarantees](https://arxiv.org/abs/2609.21340)
...
### [73] [CESBench: Benchmarking Large Language Models on Cryptographic Engineering Security for IoT Devices](https://arxiv.org/abs/2609.21344)
...
### [74] [Batched Paillier-Based Hamming-Distance Computation over Binary Embeddings](https://arxiv.org/abs/2609.21364)
...
### [75] [TrustBOM: A Scalable Architecture for Confidentiality-Preserving SBOMs Across Organizations](https://arxiv.org/abs/2609.21419)
...
### [76] [DEFEAT: Stitching Fragmented File I/O Contexts for Early Ransomware Detection](https://arxiv.org/abs/2609.21426)
...
### [77] [HE-Guardrail: A Homomorphic Guardrail Against Jailbreak Attacks for Encrypted Large Language Model Inference](https://arxiv.org/abs/2609.21484)
...
### [78] [ServeGuard: Verifiable, Bounded-Residual Confinement of Operator-Invisible Channels Without Revealing the Certified Read Factor](https://arxiv.org/abs/2609.21515)
...
### [79] [Critical sets of Latin squares based on autoparatopisms](https://arxiv.org/abs/2609.21532)
...
### [80] [Et Tu, MacBook? Unprivileged Keystroke Inference and Context Profiling via the Built-in IMU Side Channel](https://arxiv.org/abs/2609.21569)
...
### [81] [Micro-Collaborative Poisoning: A Distributed Attack on RAG Systems](https://arxiv.org/abs/2609.21573)
...
### [82] [CIPL: A Channel-Aware Framework for Recoverable Privacy Leakage in LLM Agents](https://arxiv.org/abs/2609.21686)
...
### [83] [TERMon: Detecting Persistent Behavioral Threats in Edge AI via Hardware-Native Ternary Runtime Monitor](https://arxiv.org/abs/2609.21713)
...
### [84] [A Framework to Quantify the Probability of Future Cyber Loss Events](https://arxiv.org/abs/2609.21717)
...
### [85] [Verifiable Computation with Trusted Execution Environments and On-Chain Digital Rights Tokens](https://arxiv.org/abs/2609.21728)
...
### [86] [CASCADE Against Jailbreaks: Combination Across Stages with Controlled Attack-Defense Evaluation](https://arxiv.org/abs/2609.21793)
*Jiale Luo,Eric Han*
...
### [87] [Watermarkable Multi-Draft Speculative Sampling via Poisson Processes](https://arxiv.org/abs/2609.21858)
...
### [88] [SFPF: Spatio-Frequency Polarization Fingerprint for Anomalous Wireless Device Detection](https://arxiv.org/abs/2609.21873)
...
### [89] [End-to-End Hard-Label Cryptanalytic Model Extraction Using Efficient Sign Recovery](https://arxiv.org/abs/2609.21941)
...
### [90] [Provisional Reachability: Containing Agents by Making Every Crossing Revocable](https://arxiv.org/abs/2609.21957)
*Yoshiaki Takashita*
...
### [91] [The Supersingular Isogeny Problem in Time and Memory $p^{1/3+o(1)}$, Unconditionally](https://arxiv.org/abs/2609.22018)
*José Luis Delgado*
...
### [92] [APort Vault: Benchmarking AI Agent Payment Authorization with the Open Agent Passport](https://arxiv.org/abs/2609.22076)
*Uchi Uchibeke*
...
### [93] [The Refutation Gap: Certifying Both Halves of an Optimality Claim](https://arxiv.org/abs/2609.20873)
*Rohan Pandey*
...
### [94] [A Formalisation of a Special Case of the Union-Closed Conjecture in Isabelle/HOL](https://arxiv.org/abs/2609.20876)
...
### [95] [Don't Blame the Model, Verify the Data: An Evaluation of SMT-based Dataset Verification](https://arxiv.org/abs/2609.20959)
...
### [96] [Robustness Analysis via Horofunction Compactification](https://arxiv.org/abs/2609.21009)
...
### [97] [The Sources of Unknowability and Self-refutation in Epistemic and Dynamic Epistemic Logic](https://arxiv.org/abs/2609.21317)
*Eiji Yamada*
...
### [98] [Compact Partial Symmetry Breaking for Graph Search Problems](https://arxiv.org/abs/2609.21555)
...
### [99] [Logics of Filter Bubbles](https://arxiv.org/abs/2609.21565)
*Lei Li,Jialiang Yan*
